...
if(USE_GPU_NEIGHBORHOOD_SEARCH)
	...
	ExternalProject_Add(
	   ...
	   BUILD_BYPRODUCTS ${ExternalInstallDir}/NeighborhoodSearch/lib/${LIB_PREFIX}cuNSearch${LIB_SUFFIX}
	   ${ExternalInstallDir}/NeighborhoodSearch/lib/${LIB_PREFIX}cuNSearch_d${LIB_SUFFIX}
	   )
	...
	ExternalProject_Add(
	   ...
	   BUILD_BYPRODUCTS ${ExternalInstallDir}/NeighborhoodSearch/lib/${LIB_PREFIX}CompactNSearch${LIB_SUFFIX}
	   ${ExternalInstallDir}/NeighborhoodSearch/lib/${LIB_PREFIX}CompactNSearch_d${LIB_SUFFIX}
	)
