...
void FluidModelModule(py::module m_sub){
	...
	py::class_<SPH::FluidModel, GenParam::ParameterObject>(m_sub, "FluidModel")
		...
		.def("setViscosityMethod", overload_cast_<const unsigned int>()(&SPH::FluidModel::setSurfaceTensionMethod))
		.def("setViscosityMethod", overload_cast_<const std::string&>()(&SPH::FluidModel::setSurfaceTensionMethod))
		...
		.def("setViscosityMethod", overload_cast_<const unsigned int>()(&SPH::FluidModel::setVorticityMethod))
		.def("setViscosityMethod", overload_cast_<const std::string &>()(&SPH::FluidModel::setVorticityMethod))
		.def("getDragMethod", &SPH::FluidModel::getDragMethod)
		.def("setViscosityMethod", overload_cast_<const unsigned int>()(&SPH::FluidModel::setDragMethod))
		.def("setViscosityMethod", overload_cast_<const std::string &>()(&SPH::FluidModel::setDragMethod))
		.def("getElasticityMethod", &SPH::FluidModel::getElasticityMethod)
		.def("setViscosityMethod", overload_cast_<const unsigned int>()(&SPH::FluidModel::setElasticityMethod))
		.def("setViscosityMethod", overload_cast_<const std::string &>()(&SPH::FluidModel::setElasticityMethod))
