...
void SurfaceTensionModule(py::module m_sub) {
    ...
    // ---------------------------------------
    py::class_<SPH::SurfaceTension_Akinci2013, SPH::NonPressureForceBase>(m_sub, "SurfaceTension_Akinci2013")
            .def(py::init<SPH::FluidModel*>())
            .def_readwrite_static("SURFACE_TENSION", &SPH::SurfaceTension_Akinci2013::SURFACE_TENSION)
            .def_readwrite_static("SURFACE_TENSION_BOUNDARY", &SPH::SurfaceTension_Akinci2013::SURFACE_TENSION_BOUNDARY)
            ...
            .def("getMethodName", &SPH::SurfaceTension_Akinci2013::getMethodName);

    // ---------------------------------------
    // Class Surface Becker 2007
    // ---------------------------------------
    py::class_<SPH::SurfaceTension_Becker2007, SPH::NonPressureForceBase>(m_sub, "SurfaceTension_Becker2007")
            .def(py::init<SPH::FluidModel*>())
            .def_readwrite_static("SURFACE_TENSION", &SPH::SurfaceTension_Becker2007::SURFACE_TENSION)
            .def_readwrite_static("SURFACE_TENSION_BOUNDARY", &SPH::SurfaceTension_Becker2007::SURFACE_TENSION_BOUNDARY)
            .def("getMethodName", &SPH::SurfaceTension_Becker2007::getMethodName);

    // ---------------------------------------
    // Class Surface He 2014
    // ---------------------------------------
    py::class_<SPH::SurfaceTension_He2014, SPH::NonPressureForceBase>(m_sub, "SurfaceTension_He2014")
            .def(py::init<SPH::FluidModel*>())
            .def_readwrite_static("SURFACE_TENSION", &SPH::SurfaceTension_He2014::SURFACE_TENSION)
            .def_readwrite_static("SURFACE_TENSION_BOUNDARY", &SPH::SurfaceTension_He2014::SURFACE_TENSION_BOUNDARY)
            ...
            .def("getMethodName", &SPH::SurfaceTension_He2014::getMethodName);

    // ---------------------------------------
    // Class Surface Tension Jeske 2023
    // ---------------------------------------
    py::class_<SPH::SurfaceTension_Jeske2023, SPH::NonPressureForceBase>(m_sub, "SurfaceTension_Jeske2023")
            .def(py::init<SPH::FluidModel*>())
            .def_readwrite_static("SURFACE_TENSION", &SPH::SurfaceTension_Jeske2023::SURFACE_TENSION)
            .def_readwrite_static("SURFACE_TENSION_BOUNDARY", &SPH::SurfaceTension_Jeske2023::SURFACE_TENSION_BOUNDARY)
            ...
            .def("getMethodName", &SPH::SurfaceTension_Jeske2023::getMethodName);
}